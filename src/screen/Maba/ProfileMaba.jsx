...
import { apiAuth, getUserInfo, logout } from '../../authUtils';
...
const ProfileMaba = () => {
    ...
    useEffect(() => {
        const fetchData = async() => {
            ...
            try{
                await axios.get(`${BASE_URL}/mahasiswabaru/1`, await apiAuth())
                .then( res => {
                    setMaba(res.data)
                })
            }catch (error) {
    ...
    return(
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            {/* Greeting */}
            <Greeting nama={maba?.nama} greet={"Penuhi kebutuhanmu lewat danus PPKMB"} />

            {/* Link ke Menu */}
            <SectionHeader title={"Menu Makanan"} onViewAllPress={() => navigation.navigate('store-maba')}/>
            ...
            <View>
                ...
                >
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <Image
                        source={require('../../../src/asset/arzudaqm.jpg')}
                        style={{
                            width: 50,
                            height: 50,
                            borderRadius: 25,
                        ...
                        <Text style={{color: '#f4f4f4'}}>Mahasiswa Baru</Text>
                        </View>
                    </View>
            ...
            {/* Link ke  Riwayat */}
            <SectionHeader title={"Riwayat Pemesanan"} onViewAllPress={() => navigation.navigate('riwayat-maba')}/>
